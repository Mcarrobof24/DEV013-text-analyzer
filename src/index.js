...
textoEntrada.addEventListener("input", function () {
  wordCount.textContent =
    "Recuento de palabras: " + analyzer.getWordCount(textoEntrada.value);
});
...
textoEntrada.addEventListener("input", function () {
  characterCount.textContent =
    "Recuento de caracteres: " + analyzer.getCharacterCount(textoEntrada.value);
});
...
textoEntrada.addEventListener("input", function () {
  characterNoSpacesCount.textContent =
    ...
    analyzer.getCharacterCountExcludingSpaces(textoEntrada.value);
});
...
textoEntrada.addEventListener("input", function () {
  numberCount.textContent =
    "Recuento de números: " + analyzer.getNumberCount(textoEntrada.value);
});
...
textoEntrada.addEventListener("input", function () {
  numberSum.textContent =
    "Suma total de números: " + analyzer.getNumberSum(textoEntrada.value);
});
...
textoEntrada.addEventListener("input", function () {
  wordLengthAverage.textContent =
    ...
    analyzer.getAverageWordLength(textoEntrada.value);
});
